  ...
  return (
    <div className="min-h-content flex md:flew-row items-center justify-between">
      ...
      <div className="flex gap-2">
        ...
        <img src={menu} onClick={showMobile} className="h-10 sm:h-12 sm:hidden" alt="" />
      </div>

      {/* Mobile Menu */}
      <div className={`${mobileActive ? 'top-0 right-0':'hidden -right-[100%]'} sm:hidden z-20 absolute w-full h-full bg-white transition-all duration-1000 `}>
        <img
          src={cross}
